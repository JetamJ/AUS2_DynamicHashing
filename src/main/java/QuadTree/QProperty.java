...
public class QProperty implements QuadTreeObject, Comparable<QuadTreeObject> {
    private int id;
    private GPS gps1;
    private GPS gps2;

    public QProperty(int id, GPS gps1, GPS gps2){
        this.id = id;
        this.gps1 = gps1;
        this.gps2 = gps2;
    }
    ...
    public String toFileString() {
        String line = "QuadTree.QProperty;" + this.id + ";"
